#!/bin/bash
echo "🚀 Setting up FairFlight v4.1 PWA (offline + auto-refresh)..."
...
<title>FairFlight PWA v4.1</title>
...
# service worker
cat > sw.js <<'JS'
const cacheName='fairflight-v4.1';
...
echo "✅ FairFlight v4.1 setup complete with auto-refresh!"
