#!/bin/bash
# auto_push_smart.sh - smart multi-type auto push with variable intervals, log rotation, and Termux notifications

LOG_FILE="$HOME/FairFlight-PWA/push_smart_log.txt"
MAX_LINES=1000   # Maximum lines before rotating the log
ROTATED_LOG="$HOME/FairFlight-PWA/push_smart_log.old"
