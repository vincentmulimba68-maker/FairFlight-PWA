#!/bin/bash
echo "🚀 Setting up FairFlight v4.2 PWA (smart auto-refresh)..."
...
<title>FairFlight PWA v4.2</title>
...
async function hashFlights(data){
...
if(currentHash===lastFlightsHash){return;} // No change, skip refresh
...
# service worker
cat > sw.js <<'JS'
const cacheName='fairflight-v4.2';
...
echo "✅ FairFlight v4.2 setup complete with smart auto-refresh!"
